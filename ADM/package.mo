...
//PARTICULATES
    ...
    TSS_In = 0.75*(In1.X.I + In1.X.S + In1.X.H + In1.X.A + In1.X.P);
    annotation(
...
//PARTICULATES
  ...
  model inflowADMonly "without WWTP"
    extends OpenWasteWater.Icons.WWSource;
    parameter Real Q = 0.4 "m³/d";
    parameter Real T = 38 "operational temperature, C";
    parameter Solubles_ADM Sin(su = 0, aa = 0, fa = 0, va = 0, bu = 0, pro = 0, ac = 0, H2 = 0, ch4 = 0, IC = 4, IN = 0.4, I = 37);
    parameter Particulates_ADM Xin(c = 107000, ch = 0, pr = 0, li = 0, su = 0, aa = 0, fa = 0, c4 = 0, pro = 0, ac = 0, H2 = 0, I = 2800);
    OpenWasteWater.ADM.OutFlow Out1 annotation(
      Placement(visible = true, transformation(origin = {98, -4}, extent = {{-18, -18}, {18, 18}}, rotation = 0), iconTransformation(origin = {88, 14}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    Out1.Q = -abs(Q);
    Out1.T = T;
//SOLUBLES
...
//PARTICULATES
  ...
  model WasteSludgeADM
    extends OpenWasteWater.Icons.SludgeSink;
    Real Q, T;
    Solubles_ADM S;
    Particulates_ADM X;
    OpenWasteWater.ADM.InFlow In1 annotation(
      Placement(visible = true, transformation(origin = {-107, -14}, extent = {{-24, -24}, {24, 24}}, rotation = 0), iconTransformation(origin = {-121, 0}, extent = {{-10, -10}, {10, 10}}, rotation = 0)));
  equation
    Q = In1.Q;
    T = In1.T;
    S = In1.S;
  ...
  model CSTR_ADM
    ...
    parameter Solubles_ADM Sini(su = 12, aa = 5.36, fa = 102.7, va = 10.75, bu = 14.3, pro = 16.85, ac = 39, H2 = 0.00024, ch4 = 152, IC = 52.4, IN = 527, I = 6400);
    parameter Particulates_ADM Xini(c = 5500, ch = 53, pr = 54, li = 67, su = 835, aa = 630, fa = 560, c4 = 273, pro = 129, ac = 820, H2 = 390, I = 34000);
    InFlow In1;
    OutFlow Out1;
    InPgas InP;
    GasFlowOut OutG;
...
Scenario 2 - PC_WWTP_ADM model with ES = 385 m3/d
  ...
  package adm_models
    model ADM1
      ...
      parameter Real kLa = 20 "1/d";
      parameter Solubles_ADM Sini(su = 12, aa = 5.36, fa = 102.7, va = 10.75, bu = 14.3, pro = 16.85, ac = 39, H2 = 0.00024, ch4 = 152, IC = 52.4, IN = 527, I = 6400);
      parameter Particulates_ADM Xini(c = 4400, ch = 44, pr = 44, li = 55, su = 669, aa = 504, fa = 445, c4 = 217, pro = 103, ac = 657, H2 = 316, I = 34000);
      parameter Gaseous_ADM Gini(CO2 = 50.5, H2 = 0.0078, NH3 = 0.00156, CH4 = 6260.0);
      OpenWasteWater.ADM.CSTR_ADM R1(V_R = V_D, kLa = kLa, Sini = Sini, Xini = Xini);
      OpenWasteWater.ADM.Headspace_ADM Gas(V_G = V_H, Gini = Gini);
      OpenWasteWater.ADM.InFlow In1 annotation(
      ...
      outBiogasSensor OutBiogasSensor annotation(
...
This Model is the single ADM1 model based on the Anearobic Sludge Model No.1 by the IWA
  ...
  package adm_only_examples
    model Digester
      OpenWasteWater.ADM.inflowADMonly testInflowDigester(Q = 400, Sin = OpenWasteWater.ADM.Solubles_ADM(su = 0, aa = 0, fa = 0, va = 0, bu = 0, pro = 0, ac = 0, H2 = 0, ch4 = 0, IC = 4, IN = 0.4, I = 37), Xin = OpenWasteWater.ADM.Particulates_ADM(c = 107000, ch = 0, pr = 0, li = 0, su = 0, aa = 0, fa = 0, c4 = 0, pro = 0, ac = 0, H2 = 0, I = 2800)) annotation(
        Placement(visible = true, transformation(origin = {-82, 4}, extent = {{-34, -32}, {34, 32}}, rotation = 0)));
      OpenWasteWater.ADM.WasteSludgeADM SludgeAfterDig annotation(
        Placement(visible = true, transformation(origin = {81, 6}, extent = {{-17, -20}, {17, 20}}, rotation = 0)));
      OpenWasteWater.ADM.adm_models.ADM1 Digester(Gini = OpenWasteWater.ADM.Gaseous_ADM(CO2 = 14.6, H2 = 0.0037, NH3 = 0.005, CH4 = 1646.0), Sini = OpenWasteWater.ADM.Solubles_ADM(su = 11.5, aa = 5.4, fa = 100.0, va = 10.5, bu = 14.3, pro = 16.85, ac = 44.0, H2 = 0.00024, ch4 = 130, IC = 55.5, IN = 660.0, I = 5700.0), V_D = 8000, V_H = 800, Xini = OpenWasteWater.ADM.Particulates_ADM(c = 5500, ch = 53, pr = 54, li = 67, su = 835, aa = 630, fa = 560, c4 = 273, pro = 129, ac = 820, H2 = 390, I = 34000)) annotation(
        Placement(visible = true, transformation(origin = {3, 6}, extent = {{-29, -32}, {29, 32}}, rotation = 0)));
    equation
      connect(testInflowDigester.Out1, Digester.In1) annotation(
        Line(points = {{-52, 8}, {-20, 8}, {-20, 4}, {-22, 4}}, color = {233, 185, 110}));
      connect(Digester.Out1, SludgeAfterDig.In1) annotation(
        Line(points = {{30, 6}, {60, 6}}, color = {233, 185, 110}));
      annotation(
        experiment(StartTime = 0, StopTime = 20, Tolerance = 1e-06, Interval = 0.04));
    end Digester;
  end adm_only_examples;
end ADM;
